...
def E001(file: FileHandler, state: ParsingState) -> Error:
	"""
	# E001: invalid selector type
...
def E002(file: FileHandler, state: ParsingState) -> Error:
	"""
	# E002: invalid literal
...
def E003(file: FileHandler, state: ParsingState) -> Error:
	"""
	# E003: mismatched types
...
def E004(file: FileHandler, state: ParsingState) -> Error:
	"""
	# E004: unexpected end of line
...
def _E004_guess_expected(file: FileHandler, state: ParsingState) -> str | None:
	guess: str | None = None
...
# E005: invalid mode
def E005(file: FileHandler, state: ParsingState) -> Error:
	"""
	# E005: invalid mode
...
def E006(file: FileHandler, state: ParsingState) -> Error:
	"""
	# E006: undefined macro
...
def E009(file: FileHandler, state: ParsingState) -> Error:
	"""
	# E009: unmatching number of parameters
...
def E010(file: FileHandler, state: ParsingState) -> Error:
	"""
	# E010: no overload for operator
